...
from my_sacn.sending.sender_socket_base import SenderSocketBase, DEFAULT_PORT
...
class sACNsender:
    ...
    def set_RGBfunction(self, RGBfunction: callable) -> None:
        self._sender_handler.RGBfunction = RGBfunction
