...
from my_sacn.messages.universe_discovery import UniverseDiscoveryPacket
from my_sacn.messages.sync_packet import SyncPacket
from my_sacn.messages.data_packet import calculate_multicast_addr
from my_sacn.sending.output import Output
from my_sacn.sending.sender_socket_base import SenderSocketBase, SenderSocketListener
from my_sacn.sending.sender_socket_udp import SenderSocketUDP
...
class SenderHandler(SenderSocketListener):
    ...
    def __init__(self, cid: tuple, source_name: str, outputs: Dict[int, Output], bind_address: str, bind_port: int,
                 fps: int, socket: SenderSocketBase = None, starting_RGBfunction=lambda: None):
        """
        ...
        self.RGBfunction = starting_RGBfunction
